  ...
  */
  ...
  /*
    ...
    取值：
      ...
      HW_16AVG-16次硬件平均
      HW_32AVG-32次硬件平均
    初始化：不必须初始化，默认HW_DISAVG
  */
  uint8 ADC_HwAvgSel;
    
  /*
    描述：可编程增益选择，使用相应PGA输入通道才有效
    取值：
      PGA_1GAIN-1倍增益
      PGA_2GAIN-2倍增益
      PGA_4GAIN-4倍增益
