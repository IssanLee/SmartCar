 ...
 *
 */
__INLINE boolean FTM_IsCHnF(FTM_Type *ftmx, FtmChnEnum_Type chn)
{
 ...
 *
 */
__INLINE void FTM_ClearCHnF(FTM_Type *ftmx, FtmChnEnum_Type chn)
{
 ...
 *
 */
__INLINE uint16 FTM_GetChVal(FTM_Type *ftmx, FtmChnEnum_Type chn)
{
 ...
 *
 */
__INLINE void FTM_ClearCounter(FTM_Type *ftmx)
{
