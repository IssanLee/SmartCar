 ...
 *    1--配置成功
 */
uint8 DAC_Init(DAC_InitTypeDef dac_init_struct)
{
  uint8 x;
 ...
 *    1--配置成功
 */
uint8 DAC_Deinit(DAC_InitTypeDef dac_init_struct)
{
  uint8 x;
  DAC_Type *dacx = dac_init_struct.DAC_Dacx;
 ...
 *    1--配置成功
 */
uint8 DAC_EnableIrq(DAC_InitTypeDef dac_init_struct)
{
  uint8 x;
  DAC_Type *dacx = dac_init_struct.DAC_Dacx;
 ...
 *    1--配置成功
 */
uint8 DAC_DisableIrq(DAC_InitTypeDef dac_init_struct)
{
  uint8 x;
  DAC_Type *dacx = dac_init_struct.DAC_Dacx;
 ...
 *    无
 */
void DAC_SetBufferDataN(DAC_Type *dacx, uint16 data, uint8 num)
{
  //参数检查
 ...
 *    无
 */
void DAC_SetBufferData(DAC_Type *dacx, uint16 *data, uint8 len)
{
  //参数检查
