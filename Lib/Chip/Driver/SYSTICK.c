...
* >如果在结构体初始化的时候定义回调函数，在SYSTICK_Init中开启中断功能
* >如果没有用到中断，可以通过循环判断SYSTICK_ISDONE的方式获得SYSTICK是否计数完成
* 
* 参数:
...
*   无
*/
void SYSTICK_Init(SYSTICK_InitType systick_init_structure)  
{      
...
*   无
*/
void SYSTICK_DelayUs(uint32 period_us)
{  
  uint32 i;
...
*   无
*/
void SYSTICK_DelayMs(uint32 period_ms)
{  
  uint32 i;
