...
//96X16=1536      //ascii字符范围为[32,127] = 96个字符,每个字符要用16个字节来表示  所以有96X16=1536个字节
...
unsigned char const Chinese_Code[3*2*16] = 
{
    //共3个字节，一个字占用(16+7)/8=2个行，共16列。
    /* 的 */
